...
export const translations: Record<Language, Record<string, string>> = {
  sr: {
    ...
    startGuidedTourHint: 'Agent vas vodi kroz ceo prostor uz naraciju - samo gledate i slušate.',
    exploreSelf: '🧭 Istražite sami',
    exploreSelfHint: 'Sami birate sobe, tempo i tačke koje vas zanimaju.',
    navPrev: 'Prethodna',
    navNext: 'Sledeća',
